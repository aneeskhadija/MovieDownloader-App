...
public class LatestMovieFragment extends Fragment {
    ...
    int movielimit = 20;
    String str_url = "https://yts.ag/api/v2/list_movies.json?genre=animation&sort_by=date_added&limit=" + movielimit;
    int totalPages = 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_latest_movie, container, false);
        ...
        recyclerView = root.findViewById(R.id.id_rec_latest_movie);
